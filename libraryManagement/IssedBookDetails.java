 ...
 * @author Akash
 */
public class IssedBookDetails extends javax.swing.JFrame {

    private DefaultTableModel model;

    /**
     * Creates new form IssedBookDetails
     */
    public IssedBookDetails() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 130, 530, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 210, 1280, 520));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IssedBookDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IssedBookDetails().setVisible(true);
            }
        });
    }
